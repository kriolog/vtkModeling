...
vtkPointSet* vtkMassSpring::GetControlPointsData()
{
...
void vtkMassSpring::Init(vtkUnstructuredGrid* output) {
    ...
    for (vtkIdType cellId = 0; cellId < numCells; cellId++) {
        ...
        setDistances.insert(Distance(p0, p1, this->DistanceCoefficient, this->DampingCoefficient));
        setDistances.insert(Distance(p0, p2, this->DistanceCoefficient, this->DampingCoefficient));
        setDistances.insert(Distance(p0, p3, this->DistanceCoefficient, this->DampingCoefficient));
        setDistances.insert(Distance(p1, p2, this->DistanceCoefficient, this->DampingCoefficient));
        setDistances.insert(Distance(p1, p3, this->DistanceCoefficient, this->DampingCoefficient));
        setDistances.insert(Distance(p2, p3, this->DistanceCoefficient, this->DampingCoefficient));
    }
...
int vtkMassSpring::FillInputPortInformation(int port, vtkInformation* info) {
  if (port == 0)
